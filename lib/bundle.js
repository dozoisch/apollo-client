...
var QueryManager = (function () {
    ...
    QueryManager.prototype.getCurrentQueryResult = function (observableQuery, sameVariables) {
        ...
        if (lastResult && lastResult.data && sameVariables) {
            ...
            if (newData) {
                return apolloUtilities.maybeDeepFreeze({
...
},{"apollo-link":3,"apollo-link-dedup":2,"apollo-utilities":3,"graphql/language/printer":4,"symbol-observable":6}],2:[function(require,module,exports){
(function (global, factory) {
...
},{"apollo-link":3}],3:[function(require,module,exports){
...
},{"./ponyfill":8}],8:[function(require,module,exports){
'use strict';
